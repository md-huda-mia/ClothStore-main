    ...
    <div className="mainClothDiv">
      <form id="mainForm" onSubmit={handleForm}>
        <div className="formHead">
          <h2>Input cloth details</h2>
        </div>
        <div className="sameSizeInput">
          Id:{" "}
          <input
            min={1}
            required
        ...
        <div className="sameSizeInput">
          Size:
          <label className="sizeMarging" htmlFor="radio1">
            <input value="XL" name="fav_color" id="radio1" type="radio" />
            XL
          </label>
          <label htmlFor="radio2">
            <input value="M" name="fav_color" id="radio2" type="radio" />M
          </label>
          <label htmlFor="radio3">
            <input value="L" name="fav_color" id="radio3" type="radio" />L
          </label>
        </div>
        <div className="sameSizeInput">
          Description:{" "}
          <textarea
            ...
            cols="30"
            rows="1"
            placeholder="Enter your comment briefly"></textarea>
        </div>
        <div className="terms">
          <input required id="terms" type="checkbox" />
          <label htmlFor="terms">Term and condition</label>
        </div>
